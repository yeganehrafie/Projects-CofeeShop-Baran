...
const IranianFood_ProductsHome = ({
  truncateText,
  ...
  const products_IranianFood = React.useMemo(
    () => [
      {
        id: 10,
        title: "زیتون پرورده ",
        image: ImgOlive,
        description: "لورم ایپسوم متن ساختگی با تولید نامفهوم از صنعت چاپ",
        price: "T 496",
      },
      {
        id: 12,
...
export default IranianFood_ProductsHome;
