/*****تمایم دیتا ها و استیت ها همه باید با دیتاهایی ک در api هست هم نلم باشند *****/
/*
نکته::
...
const EsprssoBar_productsAdmin = ({
  truncateText,
  categoryId,
  isCollapsed,
  onBack,
  ...
  const [isModalOpen_AddProducts_esprsso, setIsModalOpen_AddProducts_esprsso] =
    useState(false);
  const modalOpen_AddProducts_esprsso = () => {
    setIsModalOpen_AddProducts_esprsso(true);
  }; //modal add products
  const [selectedProduct, setSelectedProduct] = useState(null); // محصول انتخاب‌شده برای اپدیت
  const [
    isModalOpen_UpdateProducts_esprsso,
    setIsModalOpen_UpdateProducts_esprsso,
  ...
  const [newProduct_esprsso, setNewProduct_esprsso] = useState({
    title: "",
    price: "",
    description: "",
  ...
  // افزودن محصول
  const handleSubmit_AddProducts_esprsso = async (e) => {
    e.preventDefault();

    if (!validateFormAdd_Products(newProduct_esprsso)) return;

    try {
      const response = await axios.post(
        "http://192.168.43.127:8000/api/items",
        newProduct_esprsso // ارسال داده‌های محصول جدید
      );
  ...
  const handleUpdate = (itemId) => {
    ...
    setIsModalOpen_UpdateProducts_esprsso(true);
  };
  ...
  const handleSubmitUpdate = async (e) => {
    ...
    try {
      ...
      setIsModalOpen_UpdateProducts_esprsso(false);
  ...
  return (
    <>
      ...
      {isModalOpen_AddProducts_esprsso && (
        <div className="fixed inset-0 flex items-center justify-center z-50 ">
          <form onSubmit={handleSubmit_AddProducts_esprsso}>
                ...
                <div className="modal-container bg-slate-700 w-96 rounded-md shadow-lg overflow-hidden">
                  <div className="modal-title bg-slate-800 text-yellow-300 py-3 px-4 text-md font-meduim flex items-center justify-between">
                    ...
                    <button
                      ...
                      onClick={() =>
                        setIsModalOpen_AddProducts_esprsso(
                          !isModalOpen_AddProducts_esprsso
                        )
                      }
                    >
                  ...
                  <div className="modal-body p-6 space-y-4">
                    ...
                    <div className="flex ">
                      <div className="input-field w-full">
                        ...
                        <input
                          type="text"
                          value={newProduct_esprsso.title}
                          onChange={(e) =>
                            setNewProduct_esprsso({
                              ...newProduct_esprsso,
                    ...
                    <div className="flex ">
                      <div className="input-field w-full">
                        ...
                        <input
                          type="number"
                          value={newProduct_esprsso.price}
                          onChange={(e) =>
                            setNewProduct_esprsso({
                              ...newProduct_esprsso,
                    ...
                    <div className="input-field">
                      ...
                      <textarea
                        value={newProduct_esprsso.description}
                        onChange={(e) =>
                          setNewProduct_esprsso({
                            ...newProduct_esprsso,
      ...
      <section className="mt-10 px-4  m-auto max-w-[1300px] ">
        ...
        <div className="add_Products">
          <button
            onClick={modalOpen_AddProducts_esprsso}
...
export default EsprssoBar_productsAdmin;
